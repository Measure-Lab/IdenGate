...
CSV_PATH = r"file_name\reliability_diagram_standard.csv"
OUT_DIR  = r"file_name"
...
handles_top = [
    ...
    Patch(facecolor=c_off, edgecolor="none", label="MGF OFF, ECE=0.092"),
    Patch(facecolor=c_on,  edgecolor="none", label="MGF ON, ECE=0.075"),
]
